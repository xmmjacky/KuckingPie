...
namespace DTcms.Model
{
    ...
    public partial class orders
    {
        ...
        public string MpForHere { get; set; }
        public int takeout { get; set; }
        public int is_additional { get; set; }
        public int additional_count { get; set; }
        public int is_quick { get; set; }
        public int is_less { get; set; }
        public int is_download { get; set; }
        public string which_mp { get; set; }
        public string additional_id { get; set; }
        public int before_change_area_id { get; set; }
        public int IsCountFreeAvaliable { get; set; }
