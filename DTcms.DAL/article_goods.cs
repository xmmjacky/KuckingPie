...
namespace DTcms.DAL
{
	...
	public partial class article
	{
		...
		public int Add(Model.article_goods model)
		{
            ...
            strSql2.Append("id,goods_no,stock_quantity,market_price,sell_price,zhenghua_price,taobao_price,point,is_msg,is_top,is_red,is_hot,is_slide,taste,nick_id,opposition_id,mark,low_num,mp_img_url,change_nums,condition_price,only_company,head_line,headline_img_url)");
            ...
            SqlParameter[] parameters2 = {
                    ...
                    new SqlParameter("@zhenghua_price", SqlDbType.Decimal,5),
                    new SqlParameter("@taobao_price", SqlDbType.Decimal,5),
					...
					new SqlParameter("@is_slide", SqlDbType.TinyInt,1),
                                         new SqlParameter("@taste", SqlDbType.NVarChar,500),
                                         new SqlParameter("@nick_id", SqlDbType.NVarChar,50),
                                         new SqlParameter("@opposition_id", SqlDbType.Int,4),
                                         new SqlParameter("@mark", SqlDbType.NVarChar,50),
                                         new SqlParameter("@low_num", SqlDbType.Int,4),
                                         new SqlParameter("@mp_img_url", SqlDbType.NVarChar,255),
                                         new SqlParameter("@change_nums", SqlDbType.Int,4),
                                         new SqlParameter("@condition_price", SqlDbType.NVarChar,500),
                                         new SqlParameter("@only_company", SqlDbType.Int,4),
                                         new SqlParameter("@head_line", SqlDbType.Int,4),
                                         new SqlParameter("@headline_img_url", SqlDbType.NVarChar,255)
                                         };
            ...
            parameters2[5].Value = model.zhenghua_price;
            parameters2[6].Value = model.taobao_price;
            parameters2[7].Value = model.point;
            parameters2[8].Value = model.is_msg;
            parameters2[9].Value = model.is_top;
            parameters2[10].Value = model.is_red;
            parameters2[11].Value = model.is_hot;
            parameters2[12].Value = model.is_slide;
            parameters2[13].Value = model.taste;
            parameters2[14].Value = model.nick_id;
            parameters2[15].Value = model.opposition_id;
            parameters2[16].Value = model.mark;
            parameters2[17].Value = model.low_num;
            parameters2[18].Value = model.mp_img_url;
            parameters2[19].Value = model.change_nums;
            parameters2[20].Value = model.condition_price;
            parameters2[21].Value = model.only_company;
            parameters2[22].Value = model.head_line;
            parameters2[23].Value = model.headline_img_url;
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql2.Append("zhenghua_price=@zhenghua_price,");
                        strSql2.Append("taobao_price=@taobao_price,");
                        strSql2.Append("taste=@taste,");
                        strSql2.Append("nick_id=@nick_id,");
                        strSql2.Append("opposition_id=@opposition_id,");
                        strSql2.Append("mark=@mark,");
                        strSql2.Append("low_num=@low_num,");
                        strSql2.Append("mp_img_url=@mp_img_url,");
                        strSql2.Append("change_nums=@change_nums,");
                        strSql2.Append("condition_price=@condition_price,");
                        strSql2.Append("only_company=@only_company,");
                        strSql2.Append("head_line=@head_line,");
                        strSql2.Append("headline_img_url=@headline_img_url");
                        ...
                        parameters2[11].Value = model.zhenghua_price;
                        parameters2[12].Value = model.taobao_price;
                        parameters2[13].Value = model.taste;
                        parameters2[14].Value = model.nick_id;
                        parameters2[15].Value = model.opposition_id;
                        parameters2[16].Value = model.mark;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 * from view_article_goods ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["zhenghua_price"] != null && ds.Tables[0].Rows[0]["zhenghua_price"].ToString() != "")
                {
                    model.zhenghua_price = decimal.Parse(ds.Tables[0].Rows[0]["zhenghua_price"].ToString());
                }
                if (ds.Tables[0].Rows[0]["taobao_price"] != null && ds.Tables[0].Rows[0]["taobao_price"].ToString() != "")
                {
                    model.taobao_price = decimal.Parse(ds.Tables[0].Rows[0]["taobao_price"].ToString());
                }
                ...
                if (ds.Tables[0].Rows[0]["taste"] != null && ds.Tables[0].Rows[0]["taste"].ToString() != "")
                {
                    model.taste = ds.Tables[0].Rows[0]["taste"].ToString();
                }
                if (ds.Tables[0].Rows[0]["nick_id"] != null && ds.Tables[0].Rows[0]["nick_id"].ToString() != "")
                {
                    model.nick_id = int.Parse(ds.Tables[0].Rows[0]["nick_id"].ToString());
                }
                if (ds.Tables[0].Rows[0]["opposition_id"] != null && ds.Tables[0].Rows[0]["opposition_id"].ToString() != "")
                {
                    model.opposition_id = int.Parse(ds.Tables[0].Rows[0]["opposition_id"].ToString());
                }
                if (ds.Tables[0].Rows[0]["mark"] != null && ds.Tables[0].Rows[0]["mark"].ToString() != "")
                {
                    model.mark = ds.Tables[0].Rows[0]["mark"].ToString();
                }
                if (ds.Tables[0].Rows[0]["low_num"] != null && ds.Tables[0].Rows[0]["low_num"].ToString() != "")
                {
                    model.low_num = int.Parse(ds.Tables[0].Rows[0]["low_num"].ToString());
                }
                if (ds.Tables[0].Rows[0]["mp_img_url"] != null && ds.Tables[0].Rows[0]["mp_img_url"].ToString() != "")
                {
                    model.mp_img_url = ds.Tables[0].Rows[0]["mp_img_url"].ToString();
                }
                if (ds.Tables[0].Rows[0]["change_nums"] != null && ds.Tables[0].Rows[0]["change_nums"].ToString() != "")
                {
                    model.change_nums = int.Parse(ds.Tables[0].Rows[0]["change_nums"].ToString());
                }
                if (ds.Tables[0].Rows[0]["condition_price"] != null && ds.Tables[0].Rows[0]["condition_price"].ToString() != "")
                {
                    model.condition_price = ds.Tables[0].Rows[0]["condition_price"].ToString();
                }
                if (ds.Tables[0].Rows[0]["only_company"] != null && ds.Tables[0].Rows[0]["only_company"].ToString() != "")
                {
                    model.only_company = int.Parse(ds.Tables[0].Rows[0]["only_company"].ToString());
                }
                if (ds.Tables[0].Rows[0]["head_line"] != null && ds.Tables[0].Rows[0]["head_line"].ToString() != "")
                {
                    model.head_line = int.Parse(ds.Tables[0].Rows[0]["head_line"].ToString());
                }
                if (ds.Tables[0].Rows[0]["headline_img_url"] != null && ds.Tables[0].Rows[0]["headline_img_url"].ToString() != "")
                {
                    model.headline_img_url = ds.Tables[0].Rows[0]["headline_img_url"].ToString();
                }
                #endregion  父表信息end
        ...
        /// 获得查询分页数据
        /// </summary>
        public DataSet GetGoodsListUnionCombo(int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM ( ");
            strSql.Append("SELECT vag.id,vag.sort_id,vag.title,vag.sell_price,vag.category_id,vag.img_url,vag.taste,vag.is_lock,vag.add_time,vag.channel_id,'one' AS [type]  ");
            strSql.Append("FROM view_article_goods vag ");
            strSql.Append("UNION ALL ");
            strSql.Append("SELECT bgc.Id,bgc.SortId,bgc.Title,0 AS sell_price,bgc.CategoryId,bgc.Photo,bgc.Taste,bgc.Is_Lock ,bgc.AddDate,2 as channel_id,'combo' AS [type] ");
            strSql.Append("FROM bf_good_combo bgc ");
