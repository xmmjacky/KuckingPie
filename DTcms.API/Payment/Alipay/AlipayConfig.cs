...
namespace DTcms.API.Payment.Alipay
{
    ...
    public class Config
    {
        ...
        static Config()
        {
            ...
            XmlNode _privatekey = doc.SelectSingleNode(@"Root/privatekey");
            XmlNode _publickey = doc.SelectSingleNode(@"Root/publickey");
            ...
            key = _key.InnerText;
            //商家公钥
            PrivateKey = _privatekey.InnerText;
            //支付宝公钥
            Publickey = _publickey.InnerText;
            //签约支付宝账号或卖家支付宝帐户
