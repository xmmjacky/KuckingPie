<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bi_area_order_list.aspx.cs" Inherits="DTcms.Web.admin.orders.bi_area_order_list" %>
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <div style="margin-top: 7px;">
                <span style="display:inline-block;color:White;background-color:rgb(0,161,233);height: 30px;line-height: 30px;width: 150px;text-align: center;font-size: 18px;cursor:pointer;" onclick="location.href='bi_area_order_list.aspx'">区域</span>
                <span style="display:inline-block;color:Black;background-color:rgb(230,230,230);height: 30px;line-height: 30px;width: 150px;text-align: center;font-size: 18px;cursor:pointer;" onclick="location.href='bi_category_order_list.aspx'">菜品</span>
            </div>         
        </div>        
    </div>
