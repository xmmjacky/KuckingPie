...
<div id="contentTab">
    ...
    <div class="tab_con" style="display:block;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="order_table" style="border-bottom:0;">
          ...
          <%#Eval("subgoodsid")!=null ? GetSubGoods(Eval("subgoodsid").ToString()) : ""%>
          </ItemTemplate>
          <FooterTemplate>
    ...
    <div class="foot_btn_box">
        ...
        <input type="button" id="btnPrint" value="打印订单" class="btnSubmit" style="display:none;"
        onclick="parent.openDialog('商品打印预览', 'orders/order_print.aspx?id=<%=model.id %>', 850, 500);printview();" />&nbsp;
    </div>
</div>
</form>
</body>
