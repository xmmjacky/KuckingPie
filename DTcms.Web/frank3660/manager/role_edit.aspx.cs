...
namespace DTcms.Web.admin.manager
{
    public partial class role_edit : DTcms.Web.UI.ManagePage
    {
        ...
        private DataTable GetNavList()
        {
            ...
            dt.Rows.Add("orders", DTEnums.ActionEnum.View.ToString(), "网上订单&线下订单");
            dt.Rows.Add("orders", DTEnums.ActionEnum.Edit.ToString(), "修改网上订单&线下订单");
            dt.Rows.Add("orders", DTEnums.ActionEnum.Delete.ToString(), "删除网上订单&线下订单");

            dt.Rows.Add("caipinguanli", DTEnums.ActionEnum.View.ToString(), "菜品管理&下架菜品");
            dt.Rows.Add("caipinguanli", DTEnums.ActionEnum.Add.ToString(), "添加菜品&下架菜品");
            dt.Rows.Add("caipinguanli", DTEnums.ActionEnum.Edit.ToString(), "修改菜品&下架菜品");
            dt.Rows.Add("caipinguanli", DTEnums.ActionEnum.Delete.ToString(), "删除菜品&下架菜品");

            dt.Rows.Add("tongjiguanli", DTEnums.ActionEnum.View.ToString(), "查看统计管理");

            dt.Rows.Add("area", DTEnums.ActionEnum.View.ToString(), "查看区域管理");
            dt.Rows.Add("area", DTEnums.ActionEnum.Add.ToString(), "添加区域");
            dt.Rows.Add("area", DTEnums.ActionEnum.Edit.ToString(), "修改区域");
            dt.Rows.Add("area", DTEnums.ActionEnum.Delete.ToString(), "删除区域");

            dt.Rows.Add("worker", DTEnums.ActionEnum.View.ToString(), "查看区域及人员管理");
            dt.Rows.Add("worker", DTEnums.ActionEnum.Delete.ToString(), "删除区域及人员管理");

            dt.Rows.Add("dingdanhuishouzhan", DTEnums.ActionEnum.View.ToString(), "查看订单回收站");
            dt.Rows.Add("dingdanhuishouzhan", DTEnums.ActionEnum.Delete.ToString(), "清空订单回收站");

            //dt.Rows.Add("houtaizhanghaoguanli", DTEnums.ActionEnum.View.ToString(), "后台账号管理");
            //dt.Rows.Add("templet_list", DTEnums.ActionEnum.View.ToString(), "系统模板管理");
            //dt.Rows.Add("sys_config", DTEnums.ActionEnum.View.ToString(), "系统参数设置");
            dt.Rows.Add("category", DTEnums.ActionEnum.View.ToString(), "查看类别设置&虚拟类别");
            dt.Rows.Add("category", DTEnums.ActionEnum.Add.ToString(), "添加类别&虚拟类别");
            dt.Rows.Add("category", DTEnums.ActionEnum.Edit.ToString(), "修改类别&虚拟类别");
            dt.Rows.Add("category", DTEnums.ActionEnum.Delete.ToString(), "删除类别&虚拟类别");
            
            //dt.Rows.Add("mail_template", DTEnums.ActionEnum.View.ToString(), "邮件模板管理");            
            return dt;
        }
        #endregion
