    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>后台顶部可见区域：</th>
                <td>
                    <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="cboAreaw"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <th>网上订单下载区域</th>
                <td>
                    <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="cboOnLineOrderArea"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <th>后厨分单下载区域</th>
                <td>
                    <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="cboBackArea"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <th>收银平板上下架控制区域</th>
                <td>
                    <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="cboSwitchBusyArea"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <th>外送人员区域</th>
                <td>
                    <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="cboWaiterArea"></asp:CheckBoxList>
                </td>
            </tr>
            <tr>
                <th>后厨平板菜单列表</th>
                <td>
                    <asp:RadioButtonList runat="server" RepeatDirection="Horizontal" ID="cboGoodsArea"></asp:RadioButtonList><label>菜单列表选择一个</label>
                </td>
            </tr>
