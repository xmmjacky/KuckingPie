<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirm_Charge_list.aspx.cs" Inherits="DTcms.Web.frank3660.vipUser.confirm_Charge_list" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.confirm_btn_confirm').click(function () {
                $.ajax({
                    type: "post",
                    url: "/tools/vip_ajax.ashx?action=ChangeState",
                    data: {
        ...
        <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
                    <tr>
                        <th width="8%" align="left">单号<a href="#" class="icon_expand"></a></th>
                        <th width="8%" align="left">昵称<a href="#" class="icon_expand"></a></th>
                        <th width="6%" align="left">金额<a href="#" class="icon_expand"></a></th>
                        ...
                        <th width="6%">确认状态<a href="#" class="icon_expand"></a></th>
                        <th width="12%" align="left">创建时间<a href="#" class="icon_expand"></a></th>
                        <th width="8%">操作</th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("Amount")%></td>
                    <td align="center">
                        <a class="changearea" data-id="<%#Eval("Id")%>"><%#Eval("AreaName")%></a>
                    </td>
                    <td align="center" data-type="status">
                        <%# Convert.ToInt32(Eval("State"))>=1?"<label style=\"color: green;\">通过</label>":Convert.ToInt32(Eval("State"))==-1?"<label style=\"color: red;\">未通过</label>":"<label style=\"color: gray;\">待确认</label>"%>
                    </td>
                    <td><%#string.Format("{0:g}",Eval("CreateTime"))%></td>
                    <td align="center">
                        <a class="confirm_btn_confirm " data-id=" <%#Eval("id") %> " data-value="1" style="cursor: pointer;color:green">确认通过</a>
                        <a class="confirm_btn_confirm" data-id="<%#Eval("id") %>" data-value="-1" style="cursor: pointer;color:red">确认失败</a>    
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
