...
namespace BookingFood.DAL
{
	...
	public partial class bf_old_order
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "bf_old_order"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from bf_old_order");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(BookingFood.Model.bf_old_order model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into bf_old_order(");
			strSql.Append("id,name,email,tel,adress,ctry,totalPrice,orderdetail,msg,vipuserid,fromid,ischeck,sendtime,date,toDEmail,toget,suid,pstime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(BookingFood.Model.bf_old_order model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update bf_old_order set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from bf_old_order ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public BookingFood.Model.bf_old_order GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,email,tel,adress,ctry,totalPrice,orderdetail,msg,vipuserid,fromid,ischeck,sendtime,date,toDEmail,toget,suid,pstime from bf_old_order ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

			BookingFood.Model.bf_old_order model=new BookingFood.Model.bf_old_order();
		...
		/// 得到一个对象实体
		/// </summary>
		public BookingFood.Model.bf_old_order DataRowToModel(DataRow row)
		{
			BookingFood.Model.bf_old_order model=new BookingFood.Model.bf_old_order();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,email,tel,adress,ctry,totalPrice,orderdetail,msg,vipuserid,fromid,ischeck,sendtime,date,toDEmail,toget,suid,pstime ");
			strSql.Append(" FROM bf_old_order ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from bf_old_order T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "bf_old_order";
